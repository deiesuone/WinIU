Namespace WinIUCrypt
    Public Class CryptMd5
        ...
        Public Shared Function EncryptString(ByVal sourceString As String, ByVal password As String) As String
            Try
                ...
                Using encryptor As System.Security.Cryptography.ICryptoTransform = rijndael.CreateEncryptor()
        ...
        Public Shared Function DecryptString(ByVal sourceString As String, ByVal password As String) As String
            Try
                'RijndaelManagedオブジェクトを作成
                Dim rijndael As New System.Security.Cryptography.RijndaelManaged()
                ...
                '対称暗号化オブジェクトの作成
                Using decryptor As System.Security.Cryptography.ICryptoTransform = rijndael.CreateDecryptor()
        ...
        Private Shared Sub GenerateKeyFromPassword(ByVal password As String, _
            ...
            Try
                ...
                'saltを決める
                Dim salt As Byte() = System.Text.Encoding.UTF8.GetBytes("CRYPTMD5FORWINIUPASSWORDSALT")

                'Rfc2898DeriveBytesオブジェクトを作成する
                Dim deriveBytes As New System.Security.Cryptography.Rfc2898DeriveBytes(password, salt)

                '.NET Framework 1.1以下の時は、PasswordDeriveBytesを使用する
                'Dim deriveBytes As New System.Security.Cryptography.PasswordDeriveBytes(password, salt)
